                ...
                ?>
                    <tbody class="border-blue-800">
                        <tr class="odd:bg-white odd:dark:bg-neutral-50 even:bg-gray-50 even:dark:bg-blue-800 border-b dark:border-blue-800">
                            ...
                            <td class="px-6 py-4">
                                <a onclick="return confirm('Anda yakin ingin menghapus riwayat pembayaran ?')" href="delete/riwayat.php?id=<?= $data['id_pembayaran'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</a>
                            </td>
                        </tr>
