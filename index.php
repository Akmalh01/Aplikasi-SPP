...
<body>
    <div class="flex min-h-full flex-col justify-center px-6 lg:px-8 items-center w-full h-screen">
        ...
        <div class="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="auth/cek_login.php" method="POST">
                <div>
